		...
		$.ajax({
			...
			success: function(data){
				...
				for(;i<data[0].PRODUCTLIST.length;i++){
					newContent+='<li><a href="./getProductByID.action?productId='+data[0].PRODUCTLIST[i].product_id+'">'
					+'<img src="../productlist/'+data[0].PRODUCTLIST[i].product_id+'/indexPic.jpg">'
